...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='./test/DeepBGC_sample.fa')
    ...
    p = subprocess.Popen(
        ['hmmscan', '--nobias', '--domtblout', hmmoutpath, hmmdb, args.input],
    ...
    for query in queries:
        for hit in query.hits:
            ...
            if evalue > 0.01:
                continue
            bgc_feature = bgc_features_voc[pfam_id]
            if bgc_feature<=0:
                continue
